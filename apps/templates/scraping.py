...
def scrape_all():
    ...
    hemi_titles = hemispheres(browser)
...
def hemispheres(browser):
    ...
    for x in range(len(all_mars)):
        ...
        # Get link to full image and add to dictionary
        #hemi_dict['img_url'] = first_found['src']
        hemi_dict['img_url'] = first_found['href']
        # Find title
